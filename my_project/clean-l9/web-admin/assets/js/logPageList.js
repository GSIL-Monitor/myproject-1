...
$(function() {
    $('#search').on('click', function() {
        loadDataList("/admin/getLogPageList", 1);
        return false;
    }).trigger('click');
    delAllSelect('logIdList', '/admin/deleteLogList');
    /**
                        ...
                        $('#dataList').dataTable({
                            ...
                            "columns": [{
                                ...
                                "render": function(data, type, row, meta) {
                                    return '<input type="checkbox" value="' + row.logId + '" name="selDel">';
                                }
                            }, {
                                "data": "sn",
                                "render": function(data, type, row, meta) {
                                ...
                                "data": "time",
                                "render": function(data, type, row, meta) {
                                    return (row.time != undefined) ? row.time : '';
                                }
                            }, {
                                "data": "createTime",
                                "render": function(data, type, row, meta) {
                                ...
                                "render": function(data, type, row, meta) {
                                    return '<a title="删除" href="javascript:;" onclick="delSelect(this,\'/admin/deleteLogList?logIdList=' + row.logId + '\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>';
                                }
                            }],
