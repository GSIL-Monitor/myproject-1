...
class WhiteGroupModel extends BaseModelAbstract
{
	private function getResponsity($entity="CleanLibraryBundle:WhiteGroupEntity")
	{
    ...
    public function getEntityByName($groupName)
    {
    	$result = $this->getResponsity()->findOneBy(
				array(
						"groupName"=>$groupName,
