...
class MessageContentModel extends BaseModelAbstract
{
	private function getResponsity($entity="CleanLibraryBundle:MessageContentEntity")
	{
    ...
    public function addEntity($entity)
    {
		...
		return $entity->getMessageContentId();
