...
// {
// public $wxPayPubConfig=null;
// function __construct()
// {
// $wxPayPubConfig=DataFileHandler::getFileToArray("wxPayPub.json");
// }
...
// //签名步骤二：在string后加入KEY
// $String = $String."&key=".$this->wxPayPubConfig["key"];// WxPayConf_pub::KEY;
...
// curl_setopt($ch,CURLOPT_SSLCERT, $this->wxPayPubConfig["sslCertPath"]);//WxPayConf_pub::SSLCERT_PATH);
// //默认格式为PEM，可以注释
// curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
// curl_setopt($ch,CURLOPT_SSLKEY, $this->wxPayPubConfig["sslKeyPath"]);//WxPayConf_pub::SSLKEY_PATH);
// //post提交方式
// curl_setopt($ch,CURLOPT_POST, true);
// curl_setopt($ch,CURLOPT_POSTFIELDS,$xml);
// $data = curl_exec($ch);
...
// function createXml()
// {
// $this->parameters["appid"] = $this->wxPayPubConfig["appId"];// WxPayConf_pub::APPID;//公众账号ID
// $this->parameters["mch_id"] = $this->wxPayPubConfig["mchId"];// WxPayConf_pub::MCHID;//商户号
...
// //设置curl超时时间
// $this->curl_timeout = $this->wxPayPubConfig["curlTimeout"];// WxPayConf_pub::CURL_TIMEOUT;
// }
...
// {
// $urlObj["appid"] = $this->wxPayPubConfig["appId"];// WxPayConf_pub::APPID;//公众账号ID
...
// {
// $urlObj["appid"] = $this->wxPayPubConfig["appId"];// WxPayConf_pub::APPID;//公众账号ID
// $urlObj["secret"] = $this->wxPayPubConfig["appSecret"];//WxPayConf_pub::APPSECRET;
...
// {
// $jsApiObj["appId"] = $this->wxPayPubConfig["appId"];// WxPayConf_pub::APPID;//公众账号ID
// $timeStamp = time();
